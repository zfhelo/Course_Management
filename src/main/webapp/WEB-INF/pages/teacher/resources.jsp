                ...
                <div class="col-lg-4">
                    <div class="sticky-top">
                        ...
                        <nav aria-label="Page navigation example" style="margin-top: 20px">
                            <ul class="pagination">
                                <li class="page-item b"><a class="page-link" href="javascript:void(0);" onclick="toogle('student')">学生资源</a></li>
                                <li class="page-item active b"><a class="page-link" href="javascript:void(0);" onclick="toogle('teacher')">教师资源</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
